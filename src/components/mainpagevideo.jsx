...
function MainPageVideo ({videoUrl, index}) {
    ...
    return(
        <div className="flex flex-col size0:flex-[2_2_100%] size1:flex-[2_0_60%] size2:flex-[2_0_20%] size3:flex-[2_0_10%] size4:flex-[2_0_10%] size5:flex-[2_0_10%] rounded-md hover:bg-zinc-800 hover:shadow-md hover:shadow-zinc-950 my-2" >
